  ...
  return (
    <section className="relative min-h-svh sm:min-h-[600px] md:min-h-[700px] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 h-full w-full">
        <video
          src="https://mathia.nl/wp-content/uploads/2025/05/video-banner-2025-1.mp4"
          autoPlay
          muted
          loop
          playsInline
      ...
      {/* Content */}
      <div className="relative z-10 h-full min-h-[inherit] container px-4 sm:px-6 md:px-12 flex flex-col justify-center text-white py-20 sm:py-24">
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 sm:mb-6 max-w-4xl leading-tight">
          SOCIAL MEDIA DOOR{" "}
          <span className="font-serif italic text-secondary-accent">
            MATHIA
          </span>
        </h1>
        ...
        <div className="w-full sm:w-auto">
          <CTAButton
            href={CTALINK}
            text="Plan je gratis kennismaking"
            target="_blank"
          />
        </div>
      </div>
