    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F7F3EE" }}>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        ...
        <div className="mb-8 sm:mb-10">
          ...
          <h1 className="sora font-extrabold leading-tight mb-4" style={{ color: "#1A1A1A", fontSize: "clamp(24px, 5vw, 40px)" }}>
            Neem contact op
          </h1>
          <p className="lato text-sm sm:text-base text-gray-500 leading-relaxed">Heb je een vraag of wil je samenwerken? Vul het formulier in en ik kom zo snel mogelijk bij je terug.</p>
        </div>
